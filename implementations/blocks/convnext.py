...
def ResNet20(dtype=jnp.float32, num_classes=10):
    return _resnet(layers=[16, 32, 64], N=3, dtype=dtype, num_classes=num_classes)


def ResNet32(dtype=jnp.float32, num_classes=10):
    return _resnet(layers=[16, 32, 64], N=5, dtype=dtype, num_classes=num_classes)


def ResNet44(dtype=jnp.float32, num_classes=10):
    return _resnet(layers=[16, 32, 64], N=7, dtype=dtype, num_classes=num_classes)


def ResNet56(dtype=jnp.float32, num_classes=10):
    return _resnet(layers=[16, 32, 64], N=9, dtype=dtype, num_classes=num_classes)


def ResNet110(dtype=jnp.float32, num_classes=10):
    return _resnet(layers=[16, 32, 64], N=18, dtype=dtype, num_classes=num_classes)
